...
public class TesterSma {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //PRODUCER
            SmartphonePrice smartprice1 = new SmartphonePrice("apple", 500);
            SmartphonePrice smartprice2 = new SmartphonePrice("samsung", 460);


            //RETAIL
            SmartphonePrice retailprice3 = new SmartphonePrice("OPPO", 230);
            SmartphonePrice retailprice4 = new SmartphonePrice("xiaomi", 280);
